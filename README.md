...
Download the latest version as a [ZIP file](https://github.com/Berlenz/Home-Assistant-Pansonic-PLC/archive/refs/heads/main.zip), extract it, and copy the folder named `panasonic_plc`. Then continue with [Option A: Manual installation](#option-a-manual-installation) below.
